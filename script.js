document.addEventListener('DOMContentLoaded', () => {
    ...
    async function renderPokemonCard(pokemon) {
        ...
        pokemonCard.innerHTML = `
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/${details.id}.gif" alt="${pokemon.name}">
    ...
    function displayPokemonDetails(details) {
        ...
        detailsDiv.innerHTML = `
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/${details.id}.gif" alt="${details.name}">
